...
import { Settings, Share2, Grid3x3, Bookmark, Heart } from "lucide-react-native";
          ...
          <View style={styles.statsContainer}>
            <View style={styles.statItem}>
              <Text style={styles.statNumber}>
                {formatNumber(MOCK_USER.following)}
              </Text>
            ...
            <View style={styles.statItem}>
              <Text style={styles.statNumber}>
                {formatNumber(MOCK_USER.followers)}
              </Text>
